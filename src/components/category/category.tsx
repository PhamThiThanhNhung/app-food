...
const Category: React.FC<IProps> = ({ title, image }) => {
  return (
    <div
      className="group flex flex-col items-center mt-[10px] h-[198.21px] w-[134px] max-w-[134px] bg-white text-2xl rounded-[30px] shadow-orange-300 shadow-lg hover:cursor-pointer hover:bg-[#FFB100]
    "
    >
