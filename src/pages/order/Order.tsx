...
const Order = () => {
    return (
        <div className="lg:w-[932px] w-[95%] h-[550px] border-[3px] border-[#BB0707] rounded-[30px] absolute left-[50%] translate-x-[-50%] top-[50%] translate-y-[-50%] px-[16px] py-[14px]">
            ...
            <div>
                <ul className="sm:px-[40px] px-[0px]">
                    ...
                    <li className="w-[100%] h-[70px] drop-shadow-lg bg-white rounded-[25px] flex justify-between items-center text-[#BB0707] lg:text-[24px] text-[16px] font-[600px]">
